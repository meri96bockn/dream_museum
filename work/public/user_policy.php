  ...
  <div class="form_title">
    ...
    <div class="form">
      <div class="form_item policy">
        ...
        この利用規約（以下，「本規約」）は，
        <br>
        「DreamMuseum」（以下，「本サービス」）の利用条件を定めるものです。
        <br>
        登録ユーザーの皆さま（以下，「ユーザー」）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        <h2>第1条（適用）</h2>
        <p>
          本規約は，ユーザーが本サービス利用に関わる一切に適用されるものとします。
          <br>
          本サービスの運営者（以下，「運営者」）は本サービスに関し，本規約のほか，
          <br>
          ご利用にあたってのルール等，各種の定め（以下，「個別規定」）をすることがあります。
          <br>
        ...
        <p>
          ...
          <br>
          運営者がこの承認を登録希望者に通知することによって，利用登録が完了するものとします。
          <br>
        ...
        <p>
          ユーザーは，自己の責任において，
          <br>
          本サービス利用に必要なメールアドレスおよびパスワードを適切に管理するものとします。
          <br>
          ユーザーは，いかなる場合にも，
          <br>
          メールアドレスおよびパスワードを第三者に譲渡または貸与し，
          <br>
          もしくは第三者と共用することはできません。
          <br>
          運営者は，メールアドレスとパスワードの組み合わせが登録情報と一致してログインされた場合には，
          <br>
      ...
      <p>
        ...
        <br>
        または必要な権利者の許諾を得た情報に関してのみ，本サービスを利用し，投稿できるものとします。
        <br>
        ユーザーが本サービスを利用して投稿した文章の著作権については，
        <br>
        当該ユーザーその他既存の権利者に留保されるものとします。
        <br>
        ただし，運営者は，本サービスを利用して投稿された文章について，
        <br>
      ...
      <p>
        ...
        前項各号のいずれかに該当した場合，
        <br>
        ユーザーは，当然に運営者に対する一切の債務について期限の利益を失い，
        <br>
      ...
      <p>
        運営者は，本サービスに事実上または法律上の瑕疵（安全性，信頼性，正確性，完全性，有効性，特定の目的への適合性，セキュリティなどに関する欠陥，エラーやバグ，権利侵害などを含む）がないことを，
        <br>
        明示的にも黙示的にも保証しておりません。
        <br>
        ...
        <br>
        運営者の過失（重過失を除きます。）による債務不履行または不法行為によりユーザーに生じた損害のうち，
        <br>
      ...
      <p>
        ...
        <br>
        運営者は,ユーザーから,運営者が別途定める方式に従った変更届け出がない限り,
        <br>

...
<div class="forms">
  <div class="form_title">
    ...
    <div class="form">
      ...
      <h2>利用規約</h2>
        <p>
        この利用規約（以下「本規約」）は、本ウェブサイト上で提供するサービス「DreamMuseum」（以下「本サービス」）の利用条件を定めるものです。
        <br>
        本サービスのご利用に際しては、本規約の全文をお読みの上、本規約に同意いただく必要があります。
        </p>
      <h2>第1条（ユーザー定義と適用）</h2>
        <ol>
          <li>
            <p>
            本規約は、本サービスを利用するユーザー（以下「ユーザー」）が本サービス利用に関わる一切に適用されるものとします。
            <br>
            ユーザーとは、ゲストユーザーと登録ユーザーの総称です。
            <br>
            ゲストユーザーとは運営者が定める登録手順を踏まずに利用できる、閲覧などのサービスを利用するユーザーのことです。
            <br>
            登録ユーザーとは、運営者が定める方法によって利用登録を申請し、運営者が承認した上で、閲覧、投稿などのサービスを利用するユーザーのことです。
            </p>
          </li>
          <li>
            <p>
            本サービスの運営者（以下、「運営者」）は本サービスに関し、本規約のほか、ご利用にあたってのルール等、各種の定め（以下、「個別規定」）をすることがあります。
            <br>
      ...
      <p>
        ユーザーは、自己の責任において、本サービス利用に必要なメールアドレスおよびパスワードを適切に管理するものとします。
        <br>
        ユーザーは、いかなる場合にも、メールアドレスおよびパスワードを第三者に譲渡または貸与し、もしくは第三者と共用することはできません。
        <br>
        運営者は、メールアドレスとパスワードの組み合わせが登録情報と一致してログインされた場合には、そのメールアドレスを登録しているユーザー自身による利用とみなします。
        <br>
        メールアドレス及びパスワードが第三者によって使用されたことによって生じた損害は、
        <br>
        運営者に故意又は重大な過失がある場合を除き、運営者は一切の責任を負わないものとします。
    </p>
    <h2>
      第4条（禁止事項）
    </h2>
    <ol>
      ...
      <li>
        <p>
          ユーザーは、本サービスの利用にあたり、以下の表現を含み、または含むと運営者が判断する内容を本サービス上に投稿し、または送信する行為をしてはなりません。
        </p>
        <ol>
          <li>過度に暴力的な表現</li>
          <li>露骨な性的表現</li>
    ...
    <ol>
      <li>
        <p>
        運営者は、以下のいずれかの事由があると判断した場合、ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。</p>
        <ol>
...
<ol>
  <li>
    <p>
      ユーザーは、自ら著作権等の必要な知的財産権を有するか、または必要な権利者の許諾を得た情報に関してのみ、本サービスを利用し、投稿できるものとします。
      <br>
      ユーザーが本サービスを利用して投稿した文章の著作権については、当該ユーザーその他既存の権利者に留保されるものとします。
      <br>
      ただし、運営者は、本サービスを利用して投稿された文章について、本サービスの改良、品質の向上、または不備の是正等ならびに本サービスの周知宣伝等に必要な範囲で利用できるものとし、ユーザーは、この利用に関して、著作者人格権を行使しないものとします。
    </p>
  </li>
  <li>
    <p>
    前項本文の定めるものを除き、
      <br>
      本サービスおよび本サービスに関連する一切の情報についての著作権およびその他の知的財産権は、すべて運営者または運営者にその利用を許諾した権利者に帰属し、ユーザーは無断で以下の行為をしてはなりません。
    </p>
    <ol>
      <li>複製</li>
      <li>譲渡・貸与</li>
    ...
    <ol>
      <li>
        <p>
          ...
          <br>
          事前の通知なく、投稿データを削除し、ユーザーに対して本サービスの全部もしくは一部の利用を制限し、またはユーザーとしての登録を抹消することができるものとします。
        </p>
        <ol>
      ...
      <li>
        <p>
          前項各号のいずれかに該当した場合、
          <br>
          ユーザーは、当然に運営者に対する一切の債務について期限の利益を失い、その時点において負担する一切の債務を直ちに一括して弁済しなければなりません。
          <br>
    ...
    <p>
      運営者は、本サービスに事実上または法律上の瑕疵（安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性、セキュリティなどに関する欠陥、エラーやバグ、権利侵害などを含む）がないことを、明示的にも黙示的にも保証しておりません。
      <br>
      運営者は、本サービスに起因してユーザーに生じたあらゆる損害について、運営者の故意又は重過失による場合を除き、一切の責任を負いません。
      <br>
      運営者の過失（重過失を除く）による債務不履行または不法行為によりユーザーに生じた損害のうち、
      <br>
      特別な事情から生じた損害（運営者またはユーザーが損害発生につき予見し、または予見し得た場合を含む）について一切の責任を負いません。
      <br>
    ...
    <p>
      運営者は予告なしに、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
    </p>
    ...
    <h2>第12条（個人情報の取扱い）</h2>
    <p>
      運営者は、本サービスの利用によって取得する個人情報については、「<a href="privacy.php">プライバシーポリシー</a>」に従い適切に取り扱うものとします。
    </p>  
